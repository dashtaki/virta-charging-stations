...
describe('spinner', () => {
    ...
    it('should station name', () => {
        cy.get('.stations-list__wrapper div div:first-child div strong').should(
            'contain',
            'Endesa'
        )
    })
    ...
    it('should show limited stations based on windowing', () => {
        ...
        cy.get('.stations-list__wrapper div div div').should(
            'have.length',
            '12'
        )
    })
